    ...
    <DashboardShell>
      ...
      <div className="flex-1">
        ...
        <div className="flex flex-col items-center mt-4 space-y-4">
          <img src="/placeholder-logo.svg" alt="Dashboard Logo" className="h-12 w-12" />
          <img src="/placeholder-user.jpg" alt="User Profile Logo" className="h-12 w-12 rounded-full" />
        </div>
